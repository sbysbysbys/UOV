...
from zeroshot.lightning_trainer import LightningDownstream
...
from zeroshot.lightning_datamodule_ import DownstreamDataModule

def main():
    """
    Code for launching the zeroshot training
    """
