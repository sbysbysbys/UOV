...
if __name__ == "__main__":
    nuscenes_path = '/root/wangfeiyue3new/sby/Segment-Any-Point-Cloud/data/sets/nuscenes'
    ...
    output_dir = "superpixels/nuscenes/superpixels_slic/"
        ...
        for scene_idx in tqdm(range(len(nusc.scene))):
            ...
            while current_sample_token != "":
                ...
                for camera_name in camera_list:
                    cam_token = current_sample["data"][camera_name]
                    cam = nusc.get("sample_data", cam_token)
                    if not os.path.exists("./superpixels/nuscenes/superpixels_slic/" + cam["token"] + ".png"):
                        compute_slic(cam_token)
                # p.map(
                #     func,
                #     [
