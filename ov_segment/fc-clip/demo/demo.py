...
def get_parser():
    ...
    parser.add_argument(
        "--input",
        default="/root/wangfeiyue3new/sby/fc-clip/random_select/",
        nargs="+",
    ...
    parser.add_argument(
        "--output",
        default="/root/wangfeiyue3new/sby/fc-clip/demo_output/",
...
if __name__ == "__main__":
    ...
    if args.input:
        if os.path.exists(args.input):
            input_pics = []
            if ".png" in args.input or ".jpg" in args.input:
                input_pics.append(args.input)
            else:
                for root, dirs, files in os.walk(args.input):
                    for file in files:
                        image_path = os.path.join(root, file)
                        if ".png" in image_path or ".jpg" in image_path:
                            input_pics.append(image_path)
            args.input = input_pics
