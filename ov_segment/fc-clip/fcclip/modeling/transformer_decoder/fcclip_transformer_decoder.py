...
class MultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def forward(self, x, mask_features, mask = None, text_classifier=None, num_templates=None):
        ...
        outputs_class, outputs_mask, attn_mask, in_vocab_feature = self.forward_prediction_heads(output, mask_features, attn_mask_target_size=size_list[0],
        ...
        for i in range(self.num_layers):
            ...
            outputs_class, outputs_mask, attn_mask, in_vocab_feature = self.forward_prediction_heads(output, mask_features, attn_mask_target_size=size_list[(i + 1) % self.num_feature_levels],
                                                                                   text_classifier=text_classifier, num_templates=num_templates)
            predictions_class.append(outputs_class)
            predictions_mask.append(outputs_mask)
        ...
        out = {
            ...
            'in_vocab_feature': in_vocab_feature
        }
        return out
    ...
    def forward_prediction_heads(self, output, mask_features, attn_mask_target_size, text_classifier, num_templates):
        ...
        return outputs_class, outputs_mask, attn_mask, class_embed
